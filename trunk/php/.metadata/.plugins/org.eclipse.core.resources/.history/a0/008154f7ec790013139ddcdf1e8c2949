...
require_once '../com.wodoop.mobile.mapmessage/services/AdminAuthService.php';
require_once '../com.wodoop.mobile.mapmessage/services/AdminDeviceAuthService.php';
